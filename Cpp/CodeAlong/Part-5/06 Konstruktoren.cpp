...
//
// - Ein Konstruktor, der nicht `explicit` markiert ist heißt *konvertierender
//   Konstruktor*.
...
// %% [markdown] lang="de" tags=["subslide"] slideshow={"slide_type": "subslide"}
//
// - Alle Konstruktoren in `MyVector` sind konvertierende Konstruktoren.
// - Der Konstruktor für `size_t` Argumente hat einen leeren Rumpf.
